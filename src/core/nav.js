...
export const getNavData = app => [
  {
    component: dynamicWrapper(app, ['models/user', 'models/login'], () => import('../core/layouts/BasicLayout')),
    layout: 'BasicLayout',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: dynamicWrapper(app, ['models/list'], () => import('../routes/List/CoverCardList')),
          },
          {
            name: '搜索列表（应用）',
            path: 'filter-card-list',
            component: dynamicWrapper(app, ['models/list'], () => import('../routes/List/FilterCardList')),
          },
          {
            name: '搜索列表（文章）',
            path: 'search',
            component: dynamicWrapper(app, ['models/list'], () => import('../routes/List/SearchList')),
          },
        ],
      },
      {
  ...
  {
    component: dynamicWrapper(app, [], () => import('../core/layouts/BlankLayout')),
    layout: 'BlankLayout',
    children: {
      name: '使用文档',
